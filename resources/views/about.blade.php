            ...
            <div class="row g-5">
                <div class="offset-lg-2 col-lg-4 col-md-6">
                    <div class="single-counter-up text-center">
                        <div class="number counter-odomitter-active">100</div>
                        <div class="botton-title">Nuron All NFT's</div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-counter-up text-center">
                        <div class="number counter-odomitter-active">500</div>
                        <div class="botton-title">All Creators</div>
                    </div>
                </div>
                <div class="offset-lg-2 col-lg-4 col-md-6">
                    <div class="single-counter-up text-center">
                        <div class="number counter-odomitter-active">700</div>
                        <div class="botton-title">Nuron Earning</div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-counter-up text-center">
                        <div class="number counter-odomitter-active up-plus">900</div>
