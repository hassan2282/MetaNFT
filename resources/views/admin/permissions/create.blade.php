...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="{{route('permissions.store')}}" method="POST" class="col-md-12">
                @csrf
                <div class="form-group has-success col-md-5">
                    ...
                    <input type="text" name="name" class="form-control" id="inputSuccess" placeholder="نام دسترسی" required>
                    <label class="control-label" for="inputPercent"><i class="fa fa-check"></i> میزان دسترسی -> بین 0 تا 100</label>
                    <input type="number" name="percent" min="0" max="100" class="form-control" id="inputPercent" placeholder="درصد دسترسی" required>
