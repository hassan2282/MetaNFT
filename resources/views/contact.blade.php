                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-delay="150" data-sal-duration="800">
                    <div class="rn-address">
                        ...
                        <div class="inner">
                            ...
                            <p><a href="tel:+989170249855">+98 917 024 9855</a></p>
                            <p><a href="tel:+9179901255">+98 917 990 1255</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="rn-address">
                        ...
                        <div class="inner">
                            ...
                            <p><a href="admin@gmail.com">admin@gmail.com</a></p>
                            <p><a href="taghavey.hassan@gmail.com">taghavey.hassan@gmail.com</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-delay="250" data-sal-duration="800">
                    <div class="rn-address">
                        ...
                        <div class="inner">
                            ...
                            <p>5678 Bangla Main Road, cities 580 <br> </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6" data-sal="slide-up" data-sal-delay="200" data-sal-duration="800">
                    <div class="form-wrapper-one registration-area">
                        ...
                        @if(Session::has('error'))
                            <p class="rounded p-2 btn-block bg-danger text-white" dir="rtl">{{Session::get('error')}}</p>
                        @endif
                        @if(Session::has('success'))
                            <p class="rounded p-2 btn-block bg-success text-white" dir="rtl">{{Session::get('success')}}</p>
                        @endif
                        <form class="form" id="contact-form" method="POST" action="{{route('contact.store')}}">
                            @csrf
                            <div class="mb-5">
                                <label for="contact-name" class="form-label">Your Name</label>
                                <input id="contact-name" name="name" class="text-secondary" value="{{auth()->user()->name}}" type="text"  >
                            </div>
                            <div class="mb-5">
                                <label for="contact-email" class="form-label">Email</label>
                                <input type="email" id="contact-email" class="text-secondary" value="{{auth()->user()->email}}" name="email"  >
                            </div>
                            <div class="mb-5">
